...
namespace Code
{
    public class ImageHelper
    {
        ...
        public static void Image_Resize(string srcPath, string desFold, int maxSize)
        {
        ...
        /// <returns></returns>
        public static bool CompressImage(string sFile, string dFile, int flag = 90, int size = 50, bool sfsc = true)
        {
